package com.DynamicOrbitals.GUI;
...
public class GuiControllerMatrix extends GuiScreen
{
    ...
    public GuiControllerMatrix()
    {
        bookPageTextures[0] = new ResourceLocation(
              DynamicOrbitals.MODID+":textures/gui/book_cover.png");
        bookPageTextures[1] = new ResourceLocation(
        		DynamicOrbitals.MODID+":textures/gui/book.png");
